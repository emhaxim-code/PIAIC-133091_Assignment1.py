...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = np.subtract(arr[0] , brr) # write your code here 
...
def function13():
    ...
    for i in range(0,7,1):
        print(i)
        if(arr[i]>5 and arr[i]<10):
            a.append(arr[i]) 
        
   
  
    ans =  a #write your code here
...
def function17():
    ...
    arr = np.where((arr % 5 ==0) & (arr % 3 ==0 ),'Yes','No')
...
def function19():
    ...
    W =  np.transpose(W)
    b =  np.array([5]) # Write your code here
